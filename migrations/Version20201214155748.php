 ...
 */
final class Version20201214155748 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD author_id INT NOT NULL, ADD episode_id_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP author_id, DROP episode_id_id');
    }
}
